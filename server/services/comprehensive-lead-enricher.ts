...
export class ComprehensiveLeadEnricher {
  ...
  async enrichSingleLead(
    ...
    const result: EnrichmentResult = {
      ...
      yearFounded: leadData.yearFounded ?? undefined,
      naicsCode: leadData.naicsCode ?? undefined,
      stateCode: leadData.stateCode ?? undefined,
      uccNumber: leadData.uccNumber ?? undefined,
      confidenceScores: {
        overall: 0,
        businessInfo: 0,
        contactInfo: 0,
