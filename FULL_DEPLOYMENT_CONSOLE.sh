#!/bin/bash
# COMPLETE DEPLOYMENT SCRIPT FOR DIGITALOCEAN CONSOLE
...
echo "✅ Database configured with password: $DB_PASSWORD"
...
echo "📦 [9/17] Installing essential tools..."
apt install -y git curl wget build-essential

# Step 10: Check for files or wait for upload
echo "📦 [10/17] Checking for application files..."
if [ ! -f "/home/leadapp/LeadStorefrontAI/package.json" ]; then
    ...
    echo ""
    echo "Method 1 - From your Mac terminal (run this in a NEW terminal window):"
    echo "  cd /Users/user/Downloads/LeadStorefrontAI"
    echo "  scp -r ./* root@138.197.82.122:/home/leadapp/LeadStorefrontAI/"
    echo ""
    echo "Method 2 - Use DigitalOcean's file upload feature"
    echo ""
...
echo "📦 [14/17] Running database migrations..."
cd /home/leadapp/LeadStorefrontAI
sudo -u leadapp npm run db:push
echo "✅ Database migrations complete"

# Step 15: Start with PM2
echo "📦 [15/17] Starting application with PM2..."
cd /home/leadapp/LeadStorefrontAI
...
echo "📦 [17/17] Configuring firewall..."
ufw --force enable
ufw allow OpenSSH
