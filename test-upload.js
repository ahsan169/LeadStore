...
async function testUploadSystem() {
  ...
  console.log('🧠 Recent Decisions:', decisions.length ? decisions.slice(0, 2) : 'No decisions yet');
  ...
  console.log('The hyper-intelligent upload system is working with:');
  console.log('- Intelligent field detection');
  console.log('- Data completeness analysis');
  console.log('- Brain-powered enrichment decisions');
  console.log('- Automatic enrichment pipeline');
}
